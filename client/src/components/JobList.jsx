...
const ALL_STATUSES = ['saved', 'applied', 'interviewing', 'offer', 'rejected', 'withdrawn'];

export default function JobList({ jobs, onEdit, onDelete, onStatusChange, hasResume, resumeText }) {

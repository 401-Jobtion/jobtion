...
function Home() {
  ...
  const [jobs] = useState([
    ...
    { id: 2, title: 'Data Analyst TD', type: 'Data', typeColor: 'green', dueDate: 'March 1, 2025', status: 'Applied' },
    { id: 3, title: 'Pinterest SWE', type: 'SWE', typeColor: 'red', dueDate: 'March 14, 2025', status: 'Applied' },
    { id: 4, title: 'NVIDIA Data Science', type: 'Data', typeColor: 'green', dueDate: 'March 14, 2025', status: 'Applied' },
    { id: 5, title: 'UofA RA', type: '', typeColor: '', dueDate: 'March 14, 2025', status: 'Applied' },
    { id: 6, title: 'McDonald cashier', type: '', typeColor: '', dueDate: 'April 1, 2025', status: 'Applied' }
  ]);
